...
function DocumentosPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Documentos"
        description="Busca global em todos os documentos do sistema."
      />
      ...
      <Card className="p-4 mb-4 grid gap-3 md:grid-cols-[2fr_1fr_1fr]">
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Buscar pelo nome do documento…"
            className="pl-9"
          />
        </div>
      ...
      <Card className="overflow-hidden">
        ...
        <div className="divide-y divide-border">
          ...
          {list.data?.map((d: any) => (
            <div
              key={d.id}
              className="grid grid-cols-1 md:grid-cols-[2fr_1.4fr_1fr_1fr_1fr_auto] gap-2 md:gap-4 px-5 py-4 items-center"
            >
              <div className="min-w-0 flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">
                    v{d.versao} · {formatBytes(d.tamanho)}
                  </p>
                </div>
              </div>
              <Link
